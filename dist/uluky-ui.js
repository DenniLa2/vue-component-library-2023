import {
  ...
  reactive as At,
  toRef as Y,
  createTextVNode as Ht,
  toDisplayString as ut,
} from 'vue'

process.env.NODE_ENV !== 'production' && Object.freeze({})
process.env.NODE_ENV !== 'production' && Object.freeze([])
const Et = () => {
  }, It = Object.prototype.hasOwnProperty, Q = (t, r) => It.call(t, r), L = (t) => typeof t == 'string',
...
function lt(t, r) {
  if (process.env.NODE_ENV !== 'production') {
    const e = L(t) ? new Ct(`[${ t }] ${ r }`) : t
    console.warn(e)
  }
}

const Pt = 'utils/dom/style'
...
function Ot(t, r = 'px') {
  ...
  if (L(t))
    return t
  lt(Pt, 'binding value must be a string or number')
}
...
var Lt = /* @__PURE__ */ Ft(jt, [['render', Kt], ['__file', 'loading.vue']])
const dt = '__epPropKey', q = (t) => t, qt = (t) => ft(t) && !!t[dt], ht = (t, r) => {
    if (!ft(t) || qt(t))
      return t
    const { values: e, required: n, default: a, type: o, validator: s } = t, l = {
      type: o,
      required: !!n,
      validator: e || s ? (g) => {
        let b = !1, m = []
        if (e && (m = Array.from(e), Q(t, 'default') && m.push(a), b || (b = m.includes(g))), s && (b || (b = s(g))), !b && m.length > 0) {
    ...
    return Q(t, 'default') && (l.default = a), l
  }, gt = (t) => Rt(Object.entries(t).map(([r, e]) => [
    r,
    ht(e, r),
  ])), X = q([
    String,
    ...
    if (t.install = (e) => {
      ...
      for (const [e, n] of Object.entries(r))
        t[e] = n
    return t
  }, Wt = (t) => (t.install = Et, t), Jt = ['', 'default', 'small', 'large'],
  Zt = ({ from: t, replacement: r, scope: e, version: n, ref: a, type: o = 'API' }, s) => {
    wt(() => u(s), (c) => {
      c && lt(e, `[${ o }] ${ t } is about to be deprecated in version ${ n }, please use ${ r } instead.
For more detail, please visit: ${ a }
`)
    }, {
      immediate: !0,
    })
  }, tt = 'el', Yt = 'is-', B = (t, r, e, n, a) => {
    let o = `${ t }-${ r }`
    return e && (o += `-${ e }`), n && (o += `__${ n }`), a && (o += `--${ a }`), o
  }, Qt = Symbol('namespaceContextKey'), Xt = (t) => {
    const r = t || w(Qt, C(tt))
    return v(() => u(r) || tt)
  }, P = (t, r) => {
    const e = Xt(r)
    return {
      ...
      bem: (i, f, p) => i && f && p ? B(e.value, t, i, f, p) : '',
      is: (i, ...f) => {
        const p = f.length >= 1 ? f[0] : !0
        return i && p ? `${ Yt }${ i }` : ''
      },
      cssVar: (i) => {
        const f = {}
...
function ae(t, r = void 0) {
  const e = it() ? w(ne, et) : et
  return t ? v(() => {
    var n, a
...
const oe = gt({
  ...
  props: oe,
  setup(t) {
    const r = t, e = P('icon'), n = v(() => {
      const { size: a, color: o } = r
      return !a && !o ? {} : {
        fontSize: zt(a) ? void 0 : Ot(a),
        '--color': o,
      }
    })
    return (a, o) => (_(), I('i', ct({
...
const rt = pt(ce), J = Symbol('formContextKey'), bt = Symbol('formItemContextKey'), ue = (t, r = {}) => {
  const e = C(void 0), n = r.prop ? e : vt('size'), a = r.global ? e : re(),
    o = r.form ? { size: void 0 } : w(J, void 0), s = r.formItem ? { size: void 0 } : w(bt, void 0)
  return v(() => n.value || u(t) || (s == null ? void 0 : s.size) || (o == null ? void 0 : o.size) || a.value || '')
}, mt = (t) => {
  const r = vt('disabled'), e = w(J, void 0)
  return v(() => r.value || u(t) || (e == null ? void 0 : e.disabled) || !1)
}, fe = () => {
  const t = w(J, void 0), r = w(bt, void 0)
  return {
    form: t,
    formItem: r,
  }
}, yt = Symbol('buttonGroupContextKey'), le = (t, r) => {
  Zt({
    from: 'type.text',
    replacement: 'link',
    version: '3.0.0',
  ...
  const e = w(yt, void 0), n = ae('button'), { form: a } = fe(), o = ue(v(() => e == null ? void 0 : e.size)), s = mt(),
    c = C(), l = Mt(), g = v(() => t.type || (e == null ? void 0 : e.type) || ''), b = v(() => {
      var k, i, f
      return (f = (i = t.autoInsertSpace) != null ? i : (k = n.value) == null ? void 0 : k.autoInsertSpace) != null ? f : !1
    }), m = v(() => t.tag === 'button' ? {
      ...
      var k
      const i = (k = l.default) == null ? void 0 : k.call(l)
      if (b.value && (i == null ? void 0 : i.length) === 1) {
        const f = i[0]
        if ((f == null ? void 0 : f.type) === $t) {
          const p = f.children
  ...
  return {
    ...
    shouldAddSpace: H,
    handleClick: (k) => {
      t.nativeType === 'reset' && (a == null || a.resetFields()), r('click', k)
    },
  }
}, de = [
  'default',
...
function me(t, r, e) {
  ...
  if (t = h(t, 360), r = h(r, 100), e = h(e, 100), r === 0)
    ...
    n = F(c, s, t + 1 / 3), a = F(c, s, t), o = F(c, s, t - 1 / 3)
  }
...
function xe(t) {
  ...
  return typeof t == 'string' && (t = $e(t)), typeof t == 'object' && (x(t.r) && x(t.g) && x(t.b) ? (r = be(t.r, t.g, t.b), s = !0, c = String(t.r).substr(-1) === '%' ? 'prgb' : 'rgb') : x(t.h) && x(t.s) && x(t.v) ? (n = T(t.s), a = T(t.v), r = ye(t.h, n, a), s = !0, c = 'hsv') : x(t.h) && x(t.s) && x(t.l) && (n = T(t.s), o = T(t.l), r = me(t.h, n, o), s = !0, c = 'hsl'), Object.prototype.hasOwnProperty.call(t, 'a') && (e = t.a)), e = _t(e), {
    ok: s,
    format: t.format || c,
...
var we = '[-\\+]?\\d+%?', Me = '[-\\+]?\\d*\\.\\d+%?', $ = '(?:'.concat(Me, ')|(?:').concat(we, ')'),
...
var Ne = (
  ...
  function () {
    function t(r, e) {
      ...
      if (r instanceof t)
        return r
      typeof r == 'number' && (r = ke(r)), this.originalInput = r
      var a = xe(r)
    ...
    return t.prototype.isDark = function () {
      ...
      var r = at(this.r, this.g, this.b), e = Math.round(r.h * 360), n = Math.round(r.s * 100),
      ...
      var r = nt(this.r, this.g, this.b), e = Math.round(r.h * 360), n = Math.round(r.s * 100),
      ...
      return r === void 0 && (r = !1), ot(this.r, this.g, this.b, r)
      ...
      if (this.a < 1)
        return !1
      for (var r = '#' + ot(this.r, this.g, this.b, !1), e = 0, n = Object.entries(K); e < n.length; e++) {
      ...
      r === void 0 && (r = 10)
      var e = this.toHsl()
      return e.l += r / 100, e.l = z(e.l), new t(e)
      ...
      r === void 0 && (r = 10)
      var e = this.toHsl()
      return e.s -= r / 100, e.s = z(e.s), new t(e)
...
function Be(t) {
  ...
  return v(() => {
    ...
    const a = t.color
    if (a) {
      const o = new Ne(a), s = t.dark ? o.tint(20).toString() : M(o, 20)
      if (t.plain)
        n = e.cssVarBlock({
        ...
        const c = t.dark ? M(o, 30) : o.tint(30).toString(),
          l = o.isDark() ? `var(${ e.cssVarName('color-white') })` : `var(${ e.cssVarName('color-black') })`
        if (n = e.cssVarBlock({
          'bg-color': a,
          'text-color': l,
          'border-color': a,
          ...
          const g = t.dark ? M(o, 50) : o.tint(50).toString()
...
const Ae = N({
  ...
  setup(t, { expose: r, emit: e }) {
    ...
    return r({
      ...
      default: V(() => [
        d.loading ? (_(), I(Nt, { key: 0 }, [
          d.$slots.loading ? R(d.$slots, 'loading', { key: 0 }) : (_(), E(u(rt), {
            key: 1,
        ...
        ], 64)) : d.icon || d.$slots.icon ? (_(), E(u(rt), { key: 1 }, {
          default: V(() => [
            d.icon ? (_(), E(O(d.icon), { key: 0 })) : R(d.$slots, 'icon', { key: 1 }),
          ]),
          _: 3,
        })) : Z('v-if', !0),
...
var St = /* @__PURE__ */ W(ze, [['__file', '/home/runner/work/element-plus/element-plus/packages/components/button/src/button-group.vue']])
const Te = pt(Ee, {
  ButtonGroup: St,
})
Wt(St)
const Fe = /* @__PURE__ */ N({
  ...
  setup(t) {
    return (r, e) => (_(), E(u(Te), { type: 'success' }, {
      default: V(() => [
        Ht(ut(r.text), 1),
      ]),
      _: 1,
...
}), Ve = { class: 'u-tag' }, Ce = /* @__PURE__ */ N({
  __name: 'UTag',
  props: {
    text: {},
  },
  setup(t) {
    return (r, e) => (_(), I('span', Ve, ut(r.text), 1))
  },
})
const Pe = (t, r) => {
  const e = t.__vccOpts || t
